...
class NeedleinHayStack {
	public static void main(String args[] ) throws Exception {
		...
		for(int i=0;i<t;i++){
			...
			String substr=str2.substring(0,l1);


			int count_str2=getCount(substr);
			//System.out.println(substr+" "+count_str2);
			...
			for(int j=0;j<l2-l1;j++){
				...
				if(count_str2==str1_count){
					ind=1;
					break;
				}
				else{

					count_str2=count_str2-(str2.charAt(j)-97)+(str2.charAt(l1+j)-97);
					//System.out.println(str1_count+"  "+count_str2+" "+(str2.charAt(j)-97)+"  "+(str2.charAt(l1+j)-97)+" "+str2.charAt(j)+" "+str2.charAt(l1+j));
