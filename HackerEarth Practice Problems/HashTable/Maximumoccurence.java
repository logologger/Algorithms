...
class Maximumoccurence {
    public static void main(String args[] ) throws Exception {
        ...
        for(int i=0;i<str.length();i++){
            ...
            hs.put(ch,hs.get(ch)!=null ? hs.get(ch)+1 : 1);
    ...
    char highestKey=(char)start_char;

    for(Map.Entry m : hs.entrySet()){

        char currentChar=Character.valueOf((Character)m.getKey());
        int currentValue=Integer.valueOf((Integer)m.getValue());
      ...
      //  System.out.println(currentValue+" "+currentChar);
         ...
         if(currentValue>highestValue){
             ...
             highestKey=currentChar;

         }
    }

    System.out.println(highestKey+" "+highestValue);
